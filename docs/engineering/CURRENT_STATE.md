...
Last updated: 2026-08-25, by Claude (Primary Engineer), starting `V2-CDO-004` (First Bounded Account/Connection Ownership & Admitted Capability Consumption Contract, CONN-001 Minimum V2 Slice) after Brain **VERIFIED / PASS / CLOSED** `V2-CDO-003` at `b9430b74fdc580ce66530899e1510bc4c5ddf2cb` — see `docs/exec-plans/completed/V2-CDO-003.md`. V1 DEL-003/AKI-GIT-001 state below is unchanged.
...
- `V2-CDO-004` (First Bounded Account/Connection Ownership & Admitted Capability Consumption Contract, CONN-001 Minimum V2 Slice) — Status: **IMPLEMENTED / SELF-VALIDATED / PENDING BRAIN AUDIT**, branch `claude/V2-CDO-004-task-packet`, cut from `25213d78386b0a023e1f6a15e56ee2d2d07bbbad` (a docs-only descendant of the verified `V2-CDO-003` closure SHA `b9430b74fdc580ce66530899e1510bc4c5ddf2cb`). Adds `src/domain/connection-authority.ts` (`SecretRef`, `AccountOwnership`, `ConnectionRequirement`, `ConnectionBinding`) and `src/domain/capability-admission.ts` (`CapabilityAdmission`), reusing `ProjectOwnershipRef` (V2-CDO-003) and the existing `required-access-connections` blueprint requirement (DEL-003) as the capability reference identity; one canonical fixture reuses the `WEBSITE_BUILD_v1` ownership lineage. C1–C12 test contract covered; 325/325 tests pass. See `docs/exec-plans/active/V2-CDO-004.md`.
